...
void KEYPAD_vidInit() {
	DIO_vidSetPinDirection(ROW0_PORT,ROW0_PIN,DIO_OUT);
	DIO_vidSetPinDirection(ROW1_PORT,ROW1_PIN,DIO_OUT);
	DIO_vidSetPinDirection(ROW2_PORT,ROW2_PIN,DIO_OUT);
	DIO_vidSetPinDirection(ROW3_PORT,ROW3_PIN,DIO_OUT);

	DIO_vidSetPinDirection(COL0_PORT,COL0_PIN,DIO_IN);
	DIO_vidSetPinValue(COL0_PORT,COL0_PIN,STD_HIGH);
	DIO_vidSetPinDirection(COL1_PORT,COL1_PIN,DIO_IN);
	DIO_vidSetPinValue(COL1_PORT,COL1_PIN,STD_HIGH);
	DIO_vidSetPinDirection(COL2_PORT,COL2_PIN,DIO_IN);
	DIO_vidSetPinValue(COL2_PORT,COL2_PIN,STD_HIGH);
	DIO_vidSetPinDirection(COL3_PORT,COL3_PIN,DIO_IN);
